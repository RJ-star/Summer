        ...
        <el-header class="app-header">
          <el-menu default-active="activeIndex"
            ...
            <el-menu-item @click="invitationVisable=true">
              <span>邀请他人<i class="el-icon-plus"></i></span>
            </el-menu-item>
            <el-menu-item>
  ...
  data() {
    ...
    created(){
      ...
      .then(response => {
        ...
        {
          case 0:
            for(let i=0,len=response.data.retTeamMemEmail.length;i<len;i++)
            {
              this.temp.name=response.data.retTeamMemName[i];
              this.temp.mail=response.data.retTeamMemEmail[i];
              this.tableData.push({name:this.temp.name,mail:this.temp.mail})
            }
            break;
          case 1:
          case 2:
